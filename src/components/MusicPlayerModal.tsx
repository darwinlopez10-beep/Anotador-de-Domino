        ...
        {currentTrack && (
          <div className="bg-stone-950 px-4 py-3 border-b border-stone-800 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {/* Abrir en YouTube / Celular */}
              {currentTrack.sourceType === 'youtube' && (
                <button
                  type="button"
                  onClick={() => openInYouTube(currentTrack.videoId || extractYouTubeId(currentTrack.url) || '')}
                  title="Abrir en YouTube en tu celular o app"
                  className="p-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white font-bold shadow-md transition-transform active:scale-95 flex items-center justify-center gap-1"
                >
        ...
        <div className="p-4 sm:p-5 overflow-y-auto space-y-4 flex-1">
          ...
          {activeTab === 'search' && (
            <div className="space-y-4">
              {/* Tip / Mobile Options Banner */}
              <div className="p-2.5 sm:p-3 bg-red-950/30 border border-red-500/40 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs text-red-200/90">
                <div className="flex items-center gap-2">
                  <Youtube className="w-4.5 h-4.5 text-red-500 flex-shrink-0" />
                  <span className="text-[11px] sm:text-xs leading-tight">
                    Busca salsa, merengue, bachata o artistas. <strong>Toca para reproducir</strong> o <strong>abre directamente en la app de YouTube de tu celular</strong>.
                  </span>
                </div>
                {searchQuery.trim() && (
                  <button
                    type="button"
                    onClick={() => openYouTubeSearch(searchQuery.trim())}
                    className="self-start sm:self-auto px-2.5 py-1 bg-red-600/80 hover:bg-red-500 text-white rounded-lg text-[11px] font-bold flex items-center gap-1.5 shadow transition-all active:scale-95 whitespace-nowrap"
                  >
                    <Smartphone className="w-3.5 h-3.5" />
                    <span>Abrir en YouTube móvil</span>
              ...
              >
                <div className="flex gap-2 items-center flex-1">
                  ...
                  {/* Clean Submit Button without onPointerDown preventDefault */}
                  <button
                    type="submit"
                ...
                {/* Direct Mobile YouTube App Search Button */}
                <button
                  type="button"
                  onClick={() => openYouTubeSearch(searchQuery.trim() || 'salsa bailable')}
                  title="Abrir directamente en la app de YouTube en tu celular"
                ...
                >
                  ...
                  <span className="hidden sm:inline">Abrir en App YouTube</span>
                  <span className="sm:hidden">App YouTube</span>
                  <ExternalLink className="w-3.5 h-3.5 text-stone-400" />
                </button>
              </form>

              {/* Quick Suggestion Pills (Touch-safe without preventDefault) */}
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-1.5 flex-shrink-0">
                                {/* Abrir en YouTube (Celular / App) */}
                                <button
                                  type="button"
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    openInYouTube(track.videoId || extractYouTubeId(track.url) || '');
                                  }}
                                  title="Abrir en YouTube en tu celular o app"
                                  className="p-2 rounded-xl text-red-400 hover:text-red-300 hover:bg-red-500/20 transition-colors touch-manipulation flex items-center gap-1"
                                >
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5 flex-shrink-0">
                          ...
                          <button
                            ...
                            title="Abrir en YouTube en tu celular o app"
                            className="p-2 rounded-xl text-red-400 hover:text-red-300 hover:bg-red-500/20 transition-colors"
                          >
                            <ExternalLink className="w-4 h-4" />
                          </button>
